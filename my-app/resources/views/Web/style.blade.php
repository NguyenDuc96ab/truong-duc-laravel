...
#layout-page .header-page h2 {
    ...
    border-bottom: 1px solid #0EAD6A;
    content: "";
    text-transform: uppercase;
    color: #0EAD6A;
    font-size: 18px;
...
div#pagination span.page-node.current {
    border-bottom: 2px solid #0EAD6A;
    color: #0EAD6A;
    font-weight: bold;
}
...
.list-group-item {
    background-color: #0EAD6A !important;
    border-color: #0EAD6A !important;
}
...
#menu-blog>li.has-sub .has-sub>ul>li:hover {
    border-left: 4px solid #0EAD6A !important;
}
...
.modal-content {
    ...
    display: block;
    max-width: 100%;
    /* Để hình ảnh không vượt quá kích thước cửa sổ */
    height: auto;
...
#caption {
    ...
    display: block;
    max-width: 100%;
    /* Đảm bảo chú thích không vượt quá kích thước cửa sổ */
    text-align: center;
    color: #ccc;
    padding: 10px 0;
    height: auto;
    /* Để chú thích có thể thay đổi kích thước */
}
...
@media only screen and (max-width: 700px) {
    ...
    .close {
        ...
        right: 35px;
        color: white;
        /* Đặt màu trắng cho nút close */
    }



    /* Adjust the Caption for Mobile */
    #caption {
        width: 100%;
        max-width: none;
        height: auto;
