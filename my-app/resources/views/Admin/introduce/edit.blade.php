...
<div class="card-body">
    <form action="" method="post">
        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" value="{{ $introduce->name }}" class="form-control" id="name"
        ...
        <div class="form-group">
            ...
            <textarea name="content" id="content" class="ckeditor form-control">{{ $introduce->content }}</textarea>
