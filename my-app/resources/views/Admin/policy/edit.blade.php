...
<div class="card-body">
    <form action="" method="post">
        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" value="{{ $policy->name }}" class="form-control" id="name" placeholder="Nhập tên sản phẩm">
                </div>
            </div>
        ...
        <div class="form-group">
            ...
            <textarea name="content" id="content" class="ckeditor form-control">{{ $policy->content }}</textarea>
